...
var SearchComponent = function (_a) {
    ...
    return (React__default["default"].createElement(SearchWrapper, null,
        ...
        React__default["default"].createElement(StickerWrapper, null, stickerList.length > 0 &&
            stickerList.map(function (sticker, index) {
                return (React__default["default"].createElement(StickerImg, { src: sticker, alt: "", key: index, onClick: function () {
                        console.log(sticker);
                    } }));
            }))));
};
