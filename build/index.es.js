...
var SearchComponent = function (_a) {
    ...
    return (React__default.createElement(SearchWrapper, { size: size, backgroundColor: backgroundColor, border: border },
        ...
        stickerList.length > 0 ? (React__default.createElement(StickerWrapper$2, { column: column, scroll: scroll, border: border, backgroundColor: backgroundColor }, stickerList.map(function (sticker, index) { return (React__default.createElement(StickerImg$1, { src: sticker.stickerImg, key: index, onClick: function () {
...
var PickerComponent = function (_a) {
    ...
    return (React__default.createElement(PickerWrapper, { size: size, border: border },
        ...
        !recentView ? (stickers && isLoading ? (React__default.createElement(StickerWrapper$1, { backgroundColor: backgroundColor, border: border, column: column, scroll: scroll, isLoading: isLoading },
                ...
                btnLoading ? (React__default.createElement(DownloadBtn, { style: { right: '64px' } },
                    ...
                    React__default.createElement(Icon, { type: main.isDownload === 'Y'
                            ? hideList.indexOf(main.packageId) < 0
                                ...
                                : 'PLUS'
                            : 'PLUS' })))),
            React__default.createElement(DetailStickerWrapper, { size: size, scroll: scroll }, stickers &&
