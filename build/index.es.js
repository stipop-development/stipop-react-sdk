...
var StoreComponent = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(StoreWrapper, { color: color, size: size, border: border },
            ...
            React__default.createElement(PackageContainer, { detail: detail, color: color, scroll: scroll, border: border, onScroll: function (e) { return setCurrentScroll(e.target.scrollTop); } }, detail ? (React__default.createElement(DetailWrapper, { scroll: scroll },
                ...
                React__default.createElement(DetailStickerWrapper, { size: size }, stickers &&
                    !isLoading &&
                    stickers.map(function (sticker, index) { return (React__default.createElement("img", { src: sticker.stickerImg, alt: "", key: index })); })))) : packages && packages.length > 0 && !isLoading ? (React__default.createElement(PackageWrapper, { size: size }, packages.map(function (pack, index) { return (React__default.createElement(PackageBox, { key: index, color: color, isDownload: pack.isDownload === 'Y', onClick: function (e) {
                ...
                React__default.createElement(PackageTitle, null,
                    ...
                    React__default.createElement("span", null,
                        "\u00A9",
                        pack.artistName)),
                React__default.createElement(PackageItem, null, pack && pack.stickers && !isLoading ? (pack.stickers.map(function (sticker, index) {
                    if (index < 5) {
