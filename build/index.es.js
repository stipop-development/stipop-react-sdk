...
var SearchComponent = function (_a) {
    ...
    return (React__default.createElement(SearchWrapper, { size: size, backgroundColor: backgroundColor, border: border },
        ...
        stickerList.length > 0 ? (React__default.createElement(StickerWrapper$1, { column: column, scroll: scroll }, stickerList.map(function (sticker, index) { return (React__default.createElement(StickerImg$1, { src: sticker, key: index, onClick: function () { return stickerClick(sticker); }, size: size })); }))) : (React__default.createElement(NoSticker, null,
...
var PickerComponent = function (_a) {
    ...
    var _d = useState(null), showPackage = _d[0], setShowPackage = _d[1];
    var client = new Stipop$1(params.apikey, 'v1');
    useEffect(function () {
        var storeParams = {
            userId: params.userId,
