...
var SearchComponent = function (_a) {
    ...
    return (React__default.createElement(SearchWrapper, { size: size, backgroundColor: backgroundColor, border: border },
        ...
        React__default.createElement(StickerWrapper, { column: column, scroll: scroll }, stickerList.length > 0 &&
            stickerList.map(function (sticker, index) {
                return (React__default.createElement(StickerImg, { src: sticker, key: index, onClick: function () { return stickerClick(sticker); }, size: size }));
            }))));
};
...
export { ChattingComponent, Icon, SearchComponent };
