import r$3, { useRef, useDebugValue, useContext, createElement, useState, useEffect } from 'react';
...
function changeTypeToIconComponent(type) {
    switch (type) {
        case Type.LOGO:
            return r$3.createElement(LogoIcon, null);
        case Type.SEARCH:
            return r$3.createElement(SearchIcon, null);
        default:
            return 'icon';
    }
}
...
function Icon(_a) {
    ...
    return (r$3.createElement("div", { className: __spreadArray(__spreadArray([], (Array.isArray(className) ? className : [className]), true), [
            'stipop-icon',
...
var SearchComponent = function (_a) {
    ...
    return (r$3.createElement(SearchWrapper, null,
        r$3.createElement(SearchForm, null,
            r$3.createElement(SearchInput, { type: "text", onChange: function (e) { return setKeyword(e.target.value); } }),
            r$3.createElement(InputHolder, null,
                r$3.createElement(Icon, { type: "SEARCH" }),
                r$3.createElement("div", null,
                    r$3.createElement("span", null, "POWERED BY"),
                    r$3.createElement(Icon, { type: "LOGO" })))),
        r$3.createElement(StickerWrapper, null, stickerList.length > 0 &&
            stickerList.map(function (sticker, index) {
                return (r$3.createElement(StickerImg, { src: sticker, alt: "", key: index, onClick: function () {
                        console.log(sticker);
                    } }));
            }))));
};
