...
var StickerWrapper$2 = styled.div(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  width: 100%;\n  height: 90%;\n  overflow-y: auto;\n  display: grid;\n  grid-template-columns: ", ";\n  /* grid-template-rows: repeat(4, 1fr); */\n  grid-template-rows: ", ";\n  row-gap: 8%;\n  justify-items: center;\n  box-sizing: border-box;\n  -ms-overflow-style: ", ";\n  scrollbar-width: ", ";\n\n  &::-webkit-scrollbar {\n    display: ", ";\n    width: 9px;\n  }\n  &::-webkit-scrollbar-track {\n    /* background-color: ", ";\n    border-bottom-right-radius: ", "; */\n    display: none;\n  }\n  &::-webkit-scrollbar-thumb {\n    background: #bcc0c4;\n    border-radius: 5px;\n    &:hover {\n      background: #6d7072;\n    }\n  }\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -khtml-user-select: none;\n  -ms-user-select: none;\n"], ["\n  width: 100%;\n  height: 90%;\n  overflow-y: auto;\n  display: grid;\n  grid-template-columns: ", ";\n  /* grid-template-rows: repeat(4, 1fr); */\n  grid-template-rows: ", ";\n  row-gap: 8%;\n  justify-items: center;\n  box-sizing: border-box;\n  -ms-overflow-style: ", ";\n  scrollbar-width: ", ";\n\n  &::-webkit-scrollbar {\n    display: ", ";\n    width: 9px;\n  }\n  &::-webkit-scrollbar-track {\n    /* background-color: ", ";\n    border-bottom-right-radius: ", "; */\n    display: none;\n  }\n  &::-webkit-scrollbar-thumb {\n    background: #bcc0c4;\n    border-radius: 5px;\n    &:hover {\n      background: #6d7072;\n    }\n  }\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -khtml-user-select: none;\n  -ms-user-select: none;\n"])), function (props) {
    ...
    return props.size && props.size.imgSize
        ? "repeat(calc(400 / ".concat(props.size.imgSize, "), 1fr)")
...
var PickerComponent = function (_a) {
    ...
    return (React__default.createElement(PickerWrapper, { size: size, border: border },
        React__default.createElement(MenuBox, null,
            ...
            React__default.createElement(PickerMenu, { id: "picker-menu", backgroundColor: backgroundColor, border: border, menu: menu, onScroll: function (e) {
                ...
                myStickers.length > 0
                    ...
                    : ''),
            React__default.createElement(ArrowWrapper, { id: itemCnt - (menu && menu.listCnt ? menu.listCnt : 6) > itemNum
                    ? 'right-black'
                    ...
                    menuList.scrollTo(scrollX +
                        (menu && menu.listCnt
                            ? itemWidth * menu.listCnt
                            : itemWidth * 6), 0);
                } }, itemCnt - (menu && menu.listCnt ? menu.listCnt : 6) > itemNum ? (React__default.createElement(Icon, { type: "RIGHT_ARROW_BLACK" })) : (React__default.createElement(Icon, { type: "LEFT_ARROW" })))),
