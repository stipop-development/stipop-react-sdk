...
var PickerComponent = function (_a) {
    ...
    return (React__default.createElement(PickerWrapper, { size: size, border: border },
        ...
        !recentView ? (stickers && isLoading ? (React__default.createElement(StickerWrapper$1, { backgroundColor: backgroundColor, border: border, column: column, scroll: scroll, size: size, isLoading: isLoading },
            React__default.createElement(LoadingSpinner, { color: backgroundColor ? backgroundColor : '#ff4500' }))) : (React__default.createElement(StickerWrapper$1, { id: "sticker-wrapper", backgroundColor: backgroundColor, border: border, column: column, scroll: scroll, scrolling: scrolling, 
...
var StoreComponent = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null, isLoading ? (React__default.createElement(StoreWrapper, { color: color, size: size, border: border },
        React__default.createElement(LoadingSpinner, { color: color && color.backgroundColor ? color.backgroundColor : '#ff4500' }))) : (React__default.createElement(StoreWrapper, { color: color, size: size, border: border },
