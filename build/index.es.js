...
import React__default, { useRef, useDebugValue, useContext, createElement, useState, useEffect } from 'react';
...
var PickerComponent = function (_a) {
    ...
    var _l = useState(0); _l[0]; _l[1];
    var _m = useState(0); _m[0]; _m[1];
    var client = new Stipop$1(params.apikey, 'v1');
    var dummies = [];
    ...
    //   }, 1000)
    // }, [currentScrollTop])
    return (React__default.createElement(PickerWrapper, { size: size, border: border },
        React__default.createElement(MenuBox, null,
            ...
            React__default.createElement(PickerMenu, { id: "picker-menu", backgroundColor: backgroundColor, border: border, menu: menu, size: size, onScroll: function (e) {
                ...
                React__default.createElement(IconWrapper, { backgroundColor: backgroundColor, border: border, menu: menu, size: size },
                ...
                myStickers.length > 0 ? (myStickers.length >
                    ...
                    return pack.packageId && (React__default.createElement(PackageImgWrapper, { menu: menu, size: size, key: index, onClick: function () {
                        ...
                        React__default.createElement(PackageImg, { src: "".concat(pack.packageImg, "?d=100x100"), show: showPackage === index })));
                    ...
                    dummies.map(function (item) { return (React__default.createElement(PackageImgWrapper, { id: "dummies", menu: menu, size: size })); })))) : (dummies.map(function (item) { return (React__default.createElement(PackageImgWrapper, { id: "dummies", menu: menu, size: size })); }))),
            React__default.createElement(ArrowWrapper, { id: itemCnt - (menu && menu.listCnt ? menu.listCnt - 2 : 4) <= itemNum
                    ? 'right'
        ...
        !recentView ? (stickers && isLoading ? (React__default.createElement(StickerWrapper$1, { backgroundColor: backgroundColor, border: border, column: column, scroll: scroll, size: size, isLoading: isLoading },
            React__default.createElement(LoadingSpinner, null))) : (React__default.createElement(StickerWrapper$1, { id: "sticker-wrapper", backgroundColor: backgroundColor, border: border, column: column, scroll: scroll, scrolling: scrolling, 
            ...
            React__default.createElement(LoadingSpinner, null))) : stickers.length > 0 ? (React__default.createElement(StickerWrapper$1, { backgroundColor: backgroundColor, border: border, column: column, scroll: scroll, isLoading: isLoading, onScroll: function (e) { return console.log(e.target.scrollTop); }, onMouseEnter: function () { return setScrolling(1); }, onMouseLeave: function () { return setScrolling(0); } }, stickers.map(function (sticker, index) { return (React__default.createElement(StickerImg, { size: size, src: "".concat(sticker.stickerImg, "?d=100x100"), alt: "", key: index, onClick: function () { return stickerClick(sticker.stickerImg); } })); }))) : (React__default.createElement(StickerWrapper$1, { backgroundColor: backgroundColor, border: border, column: column, scroll: scroll, isLoading: recentView },
...
var StoreComponent = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null, isLoading ? (React__default.createElement(StoreWrapper, { color: color, size: size, border: border },
        ...
        React__default.createElement(PackageContainer, { detail: detail, color: color, scroll: scroll, border: border }, detail ? (React__default.createElement(DetailWrapper, { scroll: scroll },
            React__default.createElement(DetailBox, null,
                ...
                React__default.createElement(DetailName, null,
                    ...
                    React__default.createElement("div", { className: "artistName" },
                        "\u00A9",
                        main.artistName)),
                btnLoading ? (React__default.createElement(DownloadBtn, { style: { right: '64px' } },
                    React__default.createElement(LoadingSpinner, null))) : (React__default.createElement(DownloadBtn, { color: color, isDownload: main.isDownload === 'Y', isRecovery: main.isDownload === 'Y' &&
            ...
            btnLoading && btnLoading === pack.packageId ? (React__default.createElement(DownloadBtn, null,
                React__default.createElement(LoadingSpinner, null))) : (React__default.createElement(DownloadBtn, { color: color, isDownload: pack.isDownload === 'Y', btnHover: btnHover === pack.packageId, isRecovery: pack.isDownload === 'Y' &&
